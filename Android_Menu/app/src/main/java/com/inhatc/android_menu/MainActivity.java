...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mnuTextSize.add(ID_GROUP_TEXT_STYLE, ID_TEXTSIZE_10P, 1, "10 Pt");
        mnuTextSize.add(ID_GROUP_TEXT_STYLE, ID_TEXTSIZE_18P, 2, "18 Pt");
        mnuTextSize.add(ID_GROUP_TEXT_STYLE, ID_TEXTSIZE_24P, 3, "24 Pt");
